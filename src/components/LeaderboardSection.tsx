...
export const LeaderboardSection: React.FC = () => {
  ...
  const handleCTAClick = () => {
    if (!user) {
      ...
      // User with subscription -> Redirect to account page (affiliation tab)
  ...
  const getBadgeStyles = (rank: number) => {
    switch (rank) {
      ...
      case 3:
        return 'bg-orange-400 text-black'; // Bronze
      default:
        return 'bg-mint text-black'; // Mint for 4th and 5th
    }
  };
  ...
  return (
    <section id="leaderboard" className="relative py-16 lg:py-20 bg-grain overflow-hidden">
      {/* Decorative shapes */}
