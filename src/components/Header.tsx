      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20 lg:h-24">
          ...
          >
            ...
            <div className="bg-white border-3 border-black shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] transform rotate-1 group-hover:rotate-0 transition-transform duration-300 px-3 sm:px-4 py-1">
              <span className="font-display font-bold text-sm sm:text-base lg:text-lg">
