  ...
  const plans = [
    {
      ...
      period: '',
      priceId: 'price_1S7FekKHJNJEt6GqWfZZS2e7',
      icon: Sparkles,
      color: 'bg-green-300',
    ...
    },
    {
      ...
      period: '',
      priceId: 'price_1S7FfWKHJNJEt6GqQ5EnxyOy',
      icon: Crown,
      color: 'bg-blue-500',
    ...
    },
    {
      ...
      period: '/mois',
      priceId: 'price_1S7FgLKHJNJEt6GqNUJvmOZo',
      icon: Zap,
      color: 'bg-yellow-300',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-display font-bold text-3xl sm:text-4xl lg:text-5xl xl:text-6xl tracking-tight mb-8">
            <div className="text-black transform -rotate-3 mb-4 relative">
              <span className="inline-block bg-mint border-4 border-black px-8 py-4 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                {t('title.line1')}
              </span>
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-16">
          {(t('stats', { returnObjects: true }) as Array<{ value: string; label: string }>).map((stat, idx) => {
            const backgrounds = ["bg-mint", "bg-pink-pastel", "bg-vinted", "bg-cream"];
