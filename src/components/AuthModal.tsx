        ...
        <div className="p-3 sm:p-4">
          ...
          <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-5">
            ...
            <button
              ...
              className={`w-full flex items-center justify-center gap-2 sm:gap-3 px-3 sm:px-4 py-2.5 sm:py-3 bg-white text-black border-2 sm:border-3 border-black font-display font-bold text-xs sm:text-sm shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] sm:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] transition-all duration-200 ${
                isLoading || inAppBrowser.isInApp
                  ? 'opacity-50 cursor-not-allowed'
                  : 'hover:bg-gray-50 hover:translate-x-[-1px] hover:translate-y-[-1px] hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] sm:hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]'
              }`}
            >
            ...
            <button
              ...
              disabled={isLoading || inAppBrowser.isInApp}
              className={`w-full flex items-center justify-center gap-2 sm:gap-3 px-3 sm:px-4 py-2.5 sm:py-3 bg-[#1877F2] text-white border-2 sm:border-3 border-black font-display font-bold text-xs sm:text-sm shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] sm:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] transition-all duration-200 ${
                isLoading || inAppBrowser.isInApp
                  ? 'opacity-50 cursor-not-allowed'
                  : 'hover:bg-[#166FE5] hover:translate-x-[-1px] hover:translate-y-[-1px] hover:shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] sm:hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]'
              }`}
            >
