        ...
        <div className="bg-white border-4 border-black p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] mb-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-cream border-3 border-black p-6">
              ...
              <p>
                À <strong>0,28€ par photo</strong> de qualité pro, le ROI est immédiat :
          ...
          <div className="bg-white border-3 border-black p-6 mb-6">
            ...
            <div className="space-y-3">
              {[
                ...
                'Prix accessibles - Dès 0,28€/photo',
        ...
        <div className="bg-white border-4 border-black p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] mb-8">
          ...
          <div className="bg-vinted/10 border-3 border-black p-6">
            ...
            <div className="space-y-2">
              <p><strong>Pour tester :</strong> Pack Starter à 3,49€ (10 générations)</p>
              <p><strong>Pour vendeurs réguliers :</strong> Pack Pro à 6,99€ (25 générations)</p>
              <p><strong>Pour vendeurs intensifs :</strong> Abonnement à 11,99€/mois</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border-4 border-black p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] mb-8">
          ...
          <div className="space-y-4">
            ...
            <details className="bg-cream border-3 border-black p-6 cursor-pointer group">
              ...
              <p className="mt-4 pt-4 border-t-2 border-black">
                Avec VintDress, le prix par photo varie de 0,28€ à 0,35€ selon la formule choisie.
